...
//--------------------------------------------------------------------------------
//Command: generate_target bd_cb17.bd
//Design : bd_cb17
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_cb17,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_cb17,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "base_mb_axi_ethernet_1_0.hwdef" *) 
module bd_cb17
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AXIS_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXIS_CLK, ASSOCIATED_BUSIF m_axis_rxd:m_axis_rxs:s_axis_txc:s_axis_txd, ASSOCIATED_RESET axi_rxd_arstn:axi_rxs_arstn:axi_txc_arstn:axi_txd_arstn, CLK_DOMAIN base_mb_clk_wiz_1_0_clk_100, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.0" *) input axis_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GT0_QPLLOUTCLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GT0_QPLLOUTCLK_IN, CLK_DOMAIN base_mb_axi_ethernet_0_0_gt0_qplloutclk_out, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input gt0_qplloutclk_in;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GT0_QPLLOUTREFCLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GT0_QPLLOUTREFCLK_IN, CLK_DOMAIN base_mb_axi_ethernet_0_0_gt0_qplloutrefclk_out, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input gt0_qplloutrefclk_in;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GTREF_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GTREF_CLK, CLK_DOMAIN bd_0b46_pcs_pma_0_gtrefclk_out, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0" *) input gtref_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.GTREF_CLK_BUF CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.GTREF_CLK_BUF, CLK_DOMAIN bd_0b46_pcs_pma_0_gtrefclk_bufg_out, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0" *) input gtref_clk_buf;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.INTERRUPT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.INTERRUPT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output interrupt;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rxd TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rxd, CLK_DOMAIN base_mb_clk_wiz_1_0_clk_100, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [31:0]m_axis_rxd_tdata;
  ...
  input mmcm_locked;
  output mmcm_reset_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.PMA_RESET RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.PMA_RESET, INSERT_VIP 0, POLARITY ACTIVE_HIGH" *) input pma_reset;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.REF_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.REF_CLK, CLK_DOMAIN base_mb_clk_wiz_1_0_clk_200, FREQ_HZ 200000000, INSERT_VIP 0, PHASE 0.0" *) input ref_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXOUTCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXOUTCLK, CLK_DOMAIN bd_cb17_pcs_pma_0_rxoutclk, FREQ_HZ 62500000, INSERT_VIP 0, PHASE 0" *) output rxoutclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXUSERCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXUSERCLK, CLK_DOMAIN bd_0b46_pcs_pma_0_rxuserclk_out, FREQ_HZ 62500000, INSERT_VIP 0, PHASE 0" *) input rxuserclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXUSERCLK2 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXUSERCLK2, CLK_DOMAIN bd_0b46_pcs_pma_0_rxuserclk2_out, FREQ_HZ 62500000, INSERT_VIP 0, PHASE 0" *) input rxuserclk2;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axi, ADDR_WIDTH 18, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN base_mb_clk_wiz_1_0_clk_100, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [17:0]s_axi_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_txc TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_txc, CLK_DOMAIN base_mb_clk_wiz_1_0_clk_100, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]s_axis_txc_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_txd TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_txd, CLK_DOMAIN base_mb_clk_wiz_1_0_clk_100, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]s_axis_txd_tdata;
  ...
  input signal_detect;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.TXOUTCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.TXOUTCLK, CLK_DOMAIN bd_cb17_pcs_pma_0_txoutclk, FREQ_HZ 62500000, INSERT_VIP 0, PHASE 0" *) output txoutclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.USERCLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.USERCLK, CLK_DOMAIN bd_0b46_pcs_pma_0_userclk_out, FREQ_HZ 62500000, INSERT_VIP 0, PHASE 0" *) input userclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.USERCLK2 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.USERCLK2, CLK_DOMAIN bd_0b46_pcs_pma_0_userclk2_out, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0" *) input userclk2;
  ...
  wire gt0_qplloutclk_in_1;
  wire gt0_qplloutrefclk_in_1;
  wire gtref_clk_1;
  wire gtref_clk_buf_1;
  ...
  assign gt0_qplloutclk_in_1 = gt0_qplloutclk_in;
  assign gt0_qplloutrefclk_in_1 = gt0_qplloutrefclk_in;
  assign gtref_clk_1 = gtref_clk;
  assign gtref_clk_buf_1 = gtref_clk_buf;
  ...
  assign mmcm_reset_out = pcs_pma_mmcm_reset;
  assign pcs_pma_sfp_RXN = sfp_rxn;
  assign pcs_pma_sfp_RXP = sfp_rxp;
  assign pma_reset_1 = pma_reset;
  assign ref_clk_1 = ref_clk;
  assign rxoutclk = pcs_pma_rxoutclk;
  assign rxuserclk2_1 = rxuserclk2;
  assign rxuserclk_1 = rxuserclk;
  ...
  assign txoutclk = pcs_pma_txoutclk;
  assign userclk2_1 = userclk2;
  assign userclk_1 = userclk;
  bd_cb17_c_counter_binary_0_0 c_counter_binary_0
       (.CLK(s_axi_lite_clk_1),
        .SCLR(util_vector_logic_0_Res),
        .THRESH0(c_counter_binary_0_THRESH0));
  bd_cb17_c_shift_ram_0_0 c_shift_ram_0
       (.CE(c_counter_binary_0_THRESH0),
        .CLK(s_axi_lite_clk_1),
        .D(xlconstant_0_dout),
        .SCLR(util_vector_logic_0_Res));
  bd_cb17_eth_buf_0 eth_buf
  ...
  bd_cb17_pcs_pma_0 pcs_pma
       (.an_adv_config_val(1'b0),
        ...
        .gmii_tx_er(mac_gmii_TX_ER),
        .gmii_txd(mac_gmii_TXD),
        .gt0_qplloutclk_in(gt0_qplloutclk_in_1),
        .gt0_qplloutrefclk_in(gt0_qplloutrefclk_in_1),
        .gtrefclk(gtref_clk_1),
        .gtrefclk_bufg(gtref_clk_buf_1),
        ...
        .userclk(userclk_1),
        .userclk2(userclk2_1));
  bd_cb17_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(s_axi_lite_resetn_1),
        .Res(util_vector_logic_0_Res));
  bd_cb17_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  bd_cb17_xlconstant_config_val_0 xlconstant_config_val
       (.dout(xlconstant_config_val_dout));
  bd_cb17_xlconstant_config_vec_0 xlconstant_config_vec
       (.dout(xlconstant_config_vec_dout));
  bd_cb17_xlconstant_phyadd_0 xlconstant_phyadd
