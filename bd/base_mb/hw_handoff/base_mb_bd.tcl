...
# module references:
# IBUFDS_FOR_CLK, IM_FIFO, OBUFDS_FOR_CLK, PPS_IO, SPI_MUX, SPI_STARTUP, SPI_access, StepDrive_ShutterCtrl_Sel, TAI_IO, debug, delay, delay, elapsed_time_gen, ext_trig, firmware_ID_ROM, flash_control, in_buf_ds_1bit, in_buf_ds_4bit, in_buf_ds_1bit, pinout_three_state, step_drive, stim_gen
...
proc create_root_design { parentCell } {
  ...
  set AXI_Stream_Switch_3_1 [ create_bd_cell -type ip -vlnv user.org:user:AXI_Stream_Switch_3:1.2 AXI_Stream_Switch_3_1 ]
  ...
  set block_name debug
  set block_cell_name debug_0
  if { [catch {set debug_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $debug_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net ETH_CORE_CTRL_1_m_axis_txd_tlast [get_bd_pins ETH_CORE_CTRL_1/m_axis_txd_tlast] [get_bd_pins axi_ethernet_0/s_axis_txd_tlast]
  connect_bd_net -net ETH_CORE_CTRL_1_m_axis_txd_tvalid [get_bd_pins ETH_CORE_CTRL_1/m_axis_txd_tvalid] [get_bd_pins axi_ethernet_0/s_axis_txd_tvalid]
  ...
  connect_bd_net -net axi_ethernet_0_s_axis_txd_tready [get_bd_pins ETH_CORE_CTRL_1/m_axis_txd_tready] [get_bd_pins axi_ethernet_0/s_axis_txd_tready] [get_bd_pins debug_0/valid]
